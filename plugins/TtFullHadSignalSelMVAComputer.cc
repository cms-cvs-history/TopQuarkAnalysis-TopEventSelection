...
TtFullHadSignalSelMVAComputer::produce(edm::Event& evt, const edm::EventSetup& setup)
{
  ...
  if( nmuons!=1                    ||
    ...
    TtFullHadSignalSel selection(seljets);

    discrim = evaluateTtFullHadSignalSel(mvaComputer, selection);
  }
...
double TtFullHadSignalSelMVAComputer::DeltaPhi(math::XYZTLorentzVector v1, math::XYZTLorentzVector v2)
{
...
double TtFullHadSignalSelMVAComputer::DeltaR(math::XYZTLorentzVector v1, math::XYZTLorentzVector v2)
{
